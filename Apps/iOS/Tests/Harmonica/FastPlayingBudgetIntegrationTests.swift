...
final class FastPlayingBudgetIntegrationTests: XCTestCase {
    ...
    private func perform(_ gesture: FastGesture, on screen: HarmonicaScreenDriver) async {
        ...
        screen.touchShapingPad(heightAboveTheMiddle: gesture.heightAboveTheMiddle, vibrato: gesture.vibrato)
...
private struct FastGesture {
    ...
    let heightAboveTheMiddle: Double
    let vibrato: Double
    let lean: Double
    ...
    init(step: Int) {
        ...
        heightAboveTheMiddle = sin(Double(step) * 0.37)
